...
const client = new Discord.Client({ws: {intents: Discord.Intents.ALL}, presence: {activity: {name: "Loading", type: "WATCHING"}}});
const prefix = "+";
...
app.get("/", (req, res) => res.send('IdleCorp Profit'));
app.get("/api", require("./site/api"))
